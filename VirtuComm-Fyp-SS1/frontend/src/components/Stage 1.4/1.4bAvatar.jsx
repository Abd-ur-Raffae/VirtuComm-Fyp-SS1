...
export function Avatar2({ dialogue, isListening, onComplete, ...props }) {
  ...
  const { animations: talkingAnimations } = useFBX('/animations/Teacher_Standing_Arguing.fbx');
  ...
  return (
    <group {...props} dispose={null} ref={group} position={[2, -1.2, 1.8]} rotation={[0, -1, 0]} scale={1.4}>
