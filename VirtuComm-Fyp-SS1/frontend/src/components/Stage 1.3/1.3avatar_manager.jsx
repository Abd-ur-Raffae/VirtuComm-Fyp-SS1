...
export function useDialogueManager({ dialogue, isListening, onComplete, avatarType }) {
    ...
    return {
        ...
        updateLipSync,
        jsonFile: jsonFile || audioManagerState.sharedData.jsonFile,
        audio: audio || audioManagerState.sharedData.audio,
        lipsync: lipsync || audioManagerState.sharedData.lipsync,
        isPlaying: isPlaying || audioManagerState.sharedData.isPlaying,
        speaker: speaker || audioManagerState.sharedData.speaker,
    };
}
