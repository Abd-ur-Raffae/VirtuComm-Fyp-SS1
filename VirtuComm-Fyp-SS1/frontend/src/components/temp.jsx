...
const Subtitles = ({ apiEndpoint }) => {
    ...
    const baseMediaUrl = apiEndpoint;
...
export const AudioPlayerWithSubtitles = () => {
    return <Subtitles apiEndpoint="http://localhost:8000/api_tts/media/podcast/"/>;
};

export const Subtitles_Stage1_4 = () => {
    return <Subtitles apiEndpoint="http://localhost:8000/api_tts/media/stu_teach/"/>;
};

export const Subtitles_Stage1_5 = () => {
    return <Subtitles apiEndpoint="http://localhost:8000/api_tts/media/interview/"/>;
};