"""
Django settings for VirtuComm project.
...
SECRET_KEY = 'django-insecure-yvcrl^()w+-n-1#h7!ves_pemj0c2t0h2#mglg*or3&-rw_d$!'
...
CORS_ALLOW_HEADERS = list(default_headers) + [
    'X-CSRFToken',  # Add the custom header here
]

ROOT_URLCONF = 'VirtuComm.urls'
...
WSGI_APPLICATION = 'VirtuComm.wsgi.application'
